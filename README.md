...
**- 컴퓨터, 사용자 숫자 선택한 값 배열에 저장하는 메서드**
-[x] 컴퓨터 숫자 선택 메서드 input_computer()
  -[x] 선택하는 숫자 중복 허용X (hash_set 이용)
-[x] 사용자가 숫자 입력하는 메서드 input_user() 

**- 컴퓨터 선택 값과 사용자 입력 값 비교하기 위한 메서드**  
-[x] 볼넷 구별하기 위한 메서드 ball_check()
-[x] 스트라이크 개수 세기 위한 메서드 strike_count()
-[x] 볼 개수 세기 위한 메서드 ball_count() 

**- 게임 진행 위한 메서드** 
-[x] 게임 재시작 물어보는 메서드 init()
  -[x] 게임 횟수 (game_cnt) , 스트라이크 횟수 (strike_cnt) 초기화
-[x] 게임 결과 출력해주는 메서드 play() 
